...
""" read data"""
buyer_df = pd.read_csv('data/buyer.csv', encoding='gb2312', dtype=str,na_values='nan')
seller_df = pd.read_csv('data/seller.csv', encoding='gb2312', dtype=str,na_values='nan')
...
sr_seller_buyer_match['对应意向顺序'] = sr_seller_buyer_match["hope1_mask"] + sr_seller_buyer_match["hope2_mask"] + sr_seller_buyer_match["hope3_mask"]+ sr_seller_buyer_match["hope4_mask"]
...
cf_seller_buyer_match['对应意向顺序'] = cf_seller_buyer_match["hope1_mask"] + cf_seller_buyer_match["hope2_mask"] + cf_seller_buyer_match["hope3_mask"]+ cf_seller_buyer_match["hope4_mask"]+ cf_seller_buyer_match["hope5_mask"]
